...
/**
 * Represents the JavaScript callback `(zoom: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(zoom: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  private external fun invoke_cxx(zoom: Double): Unit
}
