...
/**
 * Wraps a Swift `(_ zoom: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.camera.bridge.swift

  private let closure: (_ zoom: Double) -> Void

  public init(_ closure: @escaping (_ zoom: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(zoom: Double) -> Void {
    self.closure(zoom)
  }
