...
VisionCamera's modern architecture, super-fast native bindings via [Nitro Modules](https://github.com/margelo/nitro), and best practices in-place allows it to be highly optimized for every Camera situation.
