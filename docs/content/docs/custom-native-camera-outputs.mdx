...
Then, create a [Nitro Modules](https://github.com/margelo/nitro) `HybridObject` that returns a [`CameraOutput`](/api/react-native-vision-camera/hybrid-objects/CameraOutput):
